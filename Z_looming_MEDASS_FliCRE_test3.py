...
def looming_stimulus(color, win,
    ...
    disk = visual.Circle(win, units='cm', fillColor=color, lineColor=color, radius=diam_start / 2)
...
if __name__ == '__main__':
    ...
    numWaves = 2  # Number of stimuli waves
    min_rest = 1.5  # Number of minutes the animal is left is in the arena after stimuli are presented
